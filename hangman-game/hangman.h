 ...
 */
std::string chooseSecretWord(std::vector<std::string> &words);
 ...
 */
bool stringContains(std::string &s, char element);
 ...
 */
void guess(std::string &word, std::map<char, bool> &guessed, std::vector<char> &errors);
 ...
 */
bool win(std::string &secretWord, std::map<char, bool> &guessed);
